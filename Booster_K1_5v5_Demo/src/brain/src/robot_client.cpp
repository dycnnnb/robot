...
// Compatibility fallback for SDK variants that do not expose these symbols.
constexpr int64_t kApiIdEnableVisualKickMode = 100010;
constexpr int64_t kApiIdRLKickBall = 100011;
constexpr int64_t kApiIdRLFancyKickBall = 100012;
